...
function showModal(ad) {
  document.getElementById('modal-photo').src = ad.photos[0]; // Для галереи добавьте слайдер
  ...
  document.getElementById('chat-button').onclick = () => {
    TelegramWebApp.openTelegramLink(`https://t.me/user?id=${ad.userId}`); // Или используйте бота для чата
  };
